...
//            //igual a null encerra a execu��o
            ...
            while (msg != null && !(msg.trim().equals("")))
            {
                ...
                /** Verificar se representa um comando da aplicacao
                 *  !play id
                 *  !players
                 *  !status
                 */

                userCommandsActions(saida, msg, );
    ...
    public void userCommandsActions(PrintStream saida, String acao, String msg) throws IOException {
        Enumeration e = CLIENTES.elements();
        while (e.hasMoreElements()) {
            // obt�m o fluxo de sa�da de um dos CLIENTES
            PrintStream chat = (PrintStream) e.nextElement();
